...
#fist
        img=Image.open(r"C:\Users\admin\Desktop\myproject\pimages\download (11).jpg")
        ...
        #second
        img1=Image.open(r"C:\Users\admin\Desktop\myproject\pimages\download (12).jpg")
       ...
       #third
        img2=Image.open(r"C:\Users\admin\Desktop\myproject\pimages\download (13).jpg")
      ...
      #four
        ...
        class_student_frame.place(x=10,y=200,width=660,height=300)  
        #student_id
        ...
        studentn_entry.grid(row=0,column=3,padx=5,sticky=W)
        ...
        phon.grid(row=3,column=0,padx=5,pady=5,sticky=W)
        ...
        button_frame.place(x=0,y=180,width=655,height=70)
        ...
        serch_frame.place(x=5,y=75,width=640,height=70)        
        ...
        tabel_frame.place(x=5,y=150,width=640,height=330)        
